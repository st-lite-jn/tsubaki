...
<?php foreach($cat_terms as $cat_term):?>
    <a class="c-btn__mini" href="<?php echo get_tag_link($cat_term->term_id);?>"><?php echo $cat_term->name;?></a>
<?php endforeach; ?>
</nav>
<?php endif;?>
...
<?php foreach($tag_terms as $tag_term):?>
    <a class="c-btn__mini" href="<?php echo get_tag_link($tag_term->term_id);?>"><?php echo $tag_term->name;?></a>
<?php endforeach; ?>
</nav>
<?php endif;?>
</div >
